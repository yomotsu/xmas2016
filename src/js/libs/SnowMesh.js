...
void main () {
	...
	gl_PointSize = 1.0 * ( scale / - mvPosition.z );
...
const SnowMesh = function ( width, height, depth, particleLength, viewHeightHalf ) {
...
SnowMesh.prototype = Object.assign( Object.create( THREE.Points.prototype ), {
